...
function single_post(){
	if(isset($_GET['post_id'])){
		...
		$user_com = $_SESSION['user_mobile'];
		$get_com = "select * from users where user_mobile ='$user_com'";
	...
	$get_posts = "select * from users where post_id='$user_id'";
	 ...
	 include("comments.php");
		...
		if(isset($_POST['reply'])){
			...
			if($comment == ""){
				...
				$insert="insert into commments (post_id,user_id,comment,comment_author,date) values('$post_id','$user_id','$comment','$user_com_name',NOW())";
				$run = mysqli_query($con,$insert);
...
function search_user(){
	...
	$run_user1 = mysqli_query($con ,$get_user);
