  ...
  <div class="row">
   ...
   <div class="col-sm-3" id="select_user">
       ...
       while($row_user = mysqli_fetch_array($run_user)){
           ...
           echo"
           <div class='container-fluid'><a style ='text-decoration:none;cursor:pointer;color:#3897f0;' href='messages.php?u_id=$user_id'>
   ...
   <div class="col-sm-6">
       <div class="loaded_msg" id="srcoll_messages">
           <?php
       ...
       if(isset($_POST['send_msg'])){
           ...
           if($msg ==""){
               echo"
               <h4 style ='color:red ;text-align:center;'>message is unable to send!</h4>
               ";
           }else if(strlen($msg)>37){
            echo"
            <h4 style ='color:red ;text-align:center;'>message is should be 37 word not too long!</h4>
            ";
   ...
   <?php
         if(isset($_GET['user_id'])){
             ...
             <li class='list-group-item' title ='User status'><strong style='color;grey'>$describe</strong></li>
             <li class='list-group-item' title ='Gender'><strong>$gen</strong></li>
             <li class='list-group-item' title ='Country'><strong>$country</strong></li>
             <li class='list-group-item' title ='User registration date'><strong>$reg_date</strong></li>
            </ul>
            </div>
