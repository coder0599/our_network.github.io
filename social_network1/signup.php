...
<div class="row">
	<div class="col-sm-12">
		<div class="main-content">
			<div class="header">
				<h3 style="text-align: center;"><strong>Join our site</strong></h3>
				<hr>
			</div>
			<div class="l-part">
				<form action="" method="post">
					...
					<div class="input-group">
						...
						<input id="mobile" type="mobile" class="form-control" placeholder="Mobile number" name="u_mobile" required="required">
					</div><br>
					<div class="input-group">
