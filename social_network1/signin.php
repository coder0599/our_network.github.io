...
<div class="row">
	<div class="col-sm-12">
		<div class="well">
			<center><h1 style="color: white;">our social network</h1></center>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-sm-12">
		<div class="main-content">
			<div class="header">
				<h3 style="text-align: center;"><strong>Login to our social media</strong></h3>
			</div>
			<div class="l-part">
				<form action="" method="post">
					<input type="mobile" name="mobile" placeholder="Mobile number" required="required" class="form-control input-md"><br>
